<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            <table class="table display" id="kategoriBuku" style="width: 1024px;">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                    ...
                    foreach ($kategori as $k) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalUpdate<?= $k['id_kategori']; ?>">
                                    <i class="fas fa-edit"></i> Ubah
                                </button>

                                <!-- Modal -->
                                <div class="modal fade" id="modalUpdate<?= $k['id_kategori']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="modalUpdateLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modalUpdateLabel">Ubah Kategori</h5>
                                                ...
                                                <form action="<?= base_url('buku/ubahKategori'); ?>" method="post">
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="kategori" class="form-control" placeholder="Input nama kategori" value="<?= $k['kategori']; ?>">
                                                        </div>
                                                    </div>
